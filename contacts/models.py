...
class Contact(models.Model):
    ...
    type = models.CharField(max_length=100, verbose_name='Tipo de cliente', choices=c_type)
    ...
    notes = models.TextField(max_length=3000, verbose_name='Notas', null=True, blank=True)